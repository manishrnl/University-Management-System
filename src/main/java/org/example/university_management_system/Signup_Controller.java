    ...
    void handleRegisterButton(ActionEvent event) {
        try {
            ...
            if (checkIfValueTaken("Users", "Mobile", studentsMobile)) {
                loadFrame.setMessage(errorMessageLabel, "Students Mobile is already " +
            ...
            // --- Role-Specific Validation --- (Students)
            ...
            try {
                ...
                try (PreparedStatement userPstmt = connection.prepareStatement(insertUserSQL, Statement.RETURN_GENERATED_KEYS)) {
                    ...
                    if (selectedImageFile != null && selectedImageFile.exists()) {
                        ...
                        userPstmt.setNull(23, java.sql.Types.BLOB);
                        userPstmt.executeUpdate();
                    }
                ...
                // 2. If the role is "Student", insert into the Students table
                if (role.equals("Student")) {
                    if (newUserId == -1) {
