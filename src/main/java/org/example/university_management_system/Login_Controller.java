...
//        errorLabel.setStyle("-fx-text-fill: GREEN");
        ...
        String query = """
                SELECT a.User_Id, u.Mobile,u.Permanent_Address,u.DOB,a.Password_Hash, u.Role, u.User_Status, u
                    .Admin_Approval_Status,u.First_Name, u.Last_Name, u.Email, u.Pan FROM Authentication a
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            ResultSet rs = pstmt.executeQuery();
            if (rs.next()) {
                LoadFrame.setMessage(errorLabel, "Login successfully. Taking you to the " +
                        "main Page", "GREEN");
                ...
                String fxmlPath = switch (role) {
                    case "Student" -> "StudentManagement/StudentsDashboard.fxml";
                    case "Admin" -> "Admin/MainDashboard.fxml";
