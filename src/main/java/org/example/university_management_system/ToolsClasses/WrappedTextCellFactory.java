...
/*
To use this WrappedTextCellFactory, you can set it to a TableColumn in your JavaFX application like this:
 tables_Column_Name.setCellFactory(new WrappedTextCellFactory<tables_Name,
 Data_Type_like_String>());
 */